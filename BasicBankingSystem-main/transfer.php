		 ...
		 function random_function()
            {
				...
				if(a==="Avinash"){
				 var arr=["Harshal","Prathap","madhavi","madhu","bunny","vimaja","teja","swathi","lakshmi"];
				 }
				 else if(a==="Harshal"){
					var arr=["Avinash","Prathap","madhavi","madhu","bunny","vimaja","teja","swathi","lakshmi"];
				}
				else if(a==="Prathap"){
					var arr=["Avinash","Harshal","madhavi","madhu","bunny","vimaja","teja","swathi","lakshmi"];
				}
				else if(a==="madhavi"){
					var arr=["Avinash","Harshal","Prathap","madhu","bunny","vimaja","teja","swathi","lakshmi"];
				 }
				 else if(a==="madhu"){
					var arr=["Avinash","Harshal","Prathap","madhavi","bunny","vimaja","teja","swathi","lakshmi"];
				 }
				 else if(a==="bunny"){
					var arr=["Avinash","Harshal","Prathap","madhavi","madhu","vimaja","teja","swathi","lakshmi"];
				 }
				 else if(a==="vimaja"){
					var arr=["Avinash","Harshal","Prathap","madhavi","madhu","bunny","teja","swathi","lakshmi"];
				 }
				 else if(a==="teja"){
					var arr=["Avinash","Harshal","Prathap","madhavi","madhu","bunny","vimaja","swathi","lakshmi"];
				 }
				 else if(a==="swathi"){
					var arr=["Avinash","Harshal","Prathap","madhavi","madhu","bunny","vimaja","teja","lakshmi"];
				 }
				 else if(a==="lakshmi"){
				 var arr=["Avinash","Harshal","Prathap","madhavi","madhu","bunny","vimaja","teja","swathi"];
				 }
                var string="";
